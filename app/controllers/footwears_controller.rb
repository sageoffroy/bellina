class FootwearsController < ApplicationController
  ...
  def show
    ...
    respond_to do |format|
      format.html
      format.json
      format.pdf {render template:'footwears/template', pdf:'Nombre', page_size: nil, page_width:'2in', page_height:'1in', margin:{top:'0.1in', bottom:'0.01in',left:'0.0in',right:'0.0in'}}
    end
  end
