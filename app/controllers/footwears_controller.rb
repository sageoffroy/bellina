class FootwearsController < ApplicationController
  ...
  def show
    ...
    respond_to do |format|
      format.html
      format.json
      format.pdf {render template:'footwears/template', pdf:'Nombre', page_size: nil, page_width:'1.5in', page_height:'0.9in', margin:{top:'0.02in', bottom:'0.02in',left:'0.02in',right:'0.02in'}}
    end
  end
