...
class TrademarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trademark" do
    assert_difference('Trademark.count') do
      post trademarks_url, params: { trademark: { description: @trademark.description, name: @trademark.name, provider_id: @trademark.provider_id } }
    end
  ...
  test "should update trademark" do
    patch trademark_url(@trademark), params: { trademark: { description: @trademark.description, name: @trademark.name, provider_id: @trademark.provider_id } }
