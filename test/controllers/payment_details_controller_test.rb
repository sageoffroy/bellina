...
class PaymentDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_detail" do
    assert_difference('PaymentDetail.count') do
      post payment_details_url, params: { payment_detail: { amount: @payment_detail.amount, payment: @payment_detail.payment, way_pay_id: @payment_detail.way_pay_id } }
    end
  ...
  test "should update payment_detail" do
    patch payment_detail_url(@payment_detail), params: { payment_detail: { amount: @payment_detail.amount, payment: @payment_detail.payment, way_pay_id: @payment_detail.way_pay_id } }
